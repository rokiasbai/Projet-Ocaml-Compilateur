...
let%test_unit "code" = 
let _ = compiler   "../../fichiersRat/pointeur/ex2TDpointeur.rat" in ()

let%test_unit "exemple_sujet" = 
let _ = compiler   "../../fichiersRat/pointeur/exemplesujet.rat" in ()

let%test_unit "exemple_sujet" = 
let _ = compiler   "../../fichiersRat/pointeur/exgraduel.rat" in ()

let%test_unit "code_adresse_pointeur_1" = 
let _ = compiler   "../../fichiersRat/pointeur/testadresse1.rat" in ()

let%test_unit "code_affectation_pointeur1" = 
let _ = compiler   "../../fichiersRat/pointeur/testaffectation1.rat" in ()

let%test_unit "code_new_pointeur1" = 
let _ = compiler   "../../fichiersRat/pointeur/testnew1.rat" in ()

let%test_unit "code_pointeur_dans_expression1" = 
let _ = compiler   "../../fichiersRat/pointeur/testpointeurdansexpression.rat" in ()

let%test_unit "testNull" =
let _ = compiler   "../../fichiersRat/pointeur/testnull.rat" in ()

let%test_unit "testNewImbriques" = 
let _ = compiler   "../../fichiersRat/pointeur/testNewSurPointeur.rat" in ()

(* tests pour les types nommés *)
let%test_unit "e" = 
let _ = compiler   "../../fichiersRat/typesnommes/exemple1.rat" in ()

let%test_unit "ee" = 
let _ = compiler   "../../fichiersRat/typesnommes/exemple2.rat" in ()

let%test_unit "ee7" = 
let _ = compiler   "../../fichiersRat/typesnommes/typesnommesimbriques.rat" in ()

(*test pour l'assignation d'addition*)
let%test_unit "exemple_sujetxx" = 
let _ = compiler   "../../fichiersRat/assignation-addition/test1.rat" in ()

let%test_unit "exemple_sujetx" = 
let _ = compiler   "../../fichiersRat/assignation-addition/test2.rat" in ()

let%test_unit "exemple--"= 
  try 
    let _ = compiler "../../fichiersRat/assignation-addition/test3.rat"
    in raise ErreurNonDetectee
  with
  | TypeInattendu(Rat,Int) -> ()

(* tests pour les enregistrements *)
let%test_unit "exemple_sujet_avec_types_nommes" = 
let _ = compiler   "../../fichiersRat/enregistrement/exemple_sujet_avec_types_nommes.rat" in ()


let%test_unit "exemple_sujet_double_declaration1" = 
try 
  let _ = compiler   "../../fichiersRat/enregistrement/exemple_sujet_double_declaration1.rat"
  in raise ErreurNonDetectee
with
| DoubleDeclaration("y") -> ()

let%test_unit "exemple_sujet_double_declaration2" = 
try
  let _ = compiler   "../../fichiersRat/enregistrement/exemple_sujet_double_declaration2.rat"
  in raise ErreurNonDetectee
with
|DoubleDeclaration("x") -> ()

let%test_unit "exemple_sujet_double_declaration3" = 
let _ = compiler   "../../fichiersRat/enregistrement/exemple_sujet_double_declaration3.rat" in ()

let%test_unit "exemple_sujet_mauvaise_utilisation_identifiant" = 
try
  let _ = compiler   "../../fichiersRat/enregistrement/exemple_sujet_mauvaise_utilisation_identifiant.rat"
  in raise ErreurNonDetectee
with
...
let%test_unit "exemple_sujet1" = 
let _ = compiler   "../../fichiersRat/enregistrement/exemple_sujet1.rat" in ()

let%test_unit "test_declaration1" = 
let _ = compiler "../../fichiersRat/enregistrement/test_declaration_1.rat" in ()
