...
type info =
  ...
  (* Information associée à un type nommé : son nom, son type réel *)
  | InfoTypedef of string * typ
  (* Information associée à un type champs d'enregistrement : le nom du champs, son type, 
  le type de l'enregistrement auquel appartient le champs, et son déplacement par rapportaux début de l'enregistrement  *)
  | InfoChamps of string * typ * typ * int
...
val modifier_adresse_info_champs : int -> info_ast -> unit